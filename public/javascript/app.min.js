var scrollToElem = function(elemID){
  ...
  window.scrollTo(
    {
    top: window.scrollX, 
    left: findPos(document.getElementById(elemID)),
    behavior: 'smooth',
    });
}
    ...
    (window.Smooth = _t),
      ...
      (c.a.Pjax.getTransition = function () {
        return c.a.BaseTransition.extend({
          ...
          onEnterCompleted: function() {
            // var hash = document.getElementById(window.location.pathname.replace("/",""));
            ...
            // if(hash ){
            //   window.scrollTo(window.scrollX, findPos(hash));
            // }
          }
        });
      }),
      ...
      c.a.BaseView.extend({
        ...
        onEnter: function () {
          ...
          G.motioTween = {
            ...
            //   )
            // ),
            "vertical letter-p": new n.a.Timeline().add(
              new n.a.Html(
                n.a.helpers.extend(
                  {
                    el: ".shape-letter-p",
            ...
            "vertical letter-b": new n.a.Timeline().add(
              new n.a.Html(
                n.a.helpers.extend(
                  {
                    el: ".shape-letter-b",
            ...
            "vertical letter-e": new n.a.Timeline().add(
              new n.a.Html(
                n.a.helpers.extend(
                  {
                    el: ".shape-letter-e1-vertical",
                    strokeDasharray: 300,
            ...
            "vertical letter-x-last": new n.a.Timeline().add(
              new n.a.Html(
                n.a.helpers.extend(
                  {
                    el: ".shape-letter-x1-last",
                    transformOrigin: "244px 126px",
                    strokeDasharray: 475,
              ...
              new n.a.Html(
                n.a.helpers.extend(
                  {
                    el: ".shape-letter-x2-last",
                    transformOrigin: "244px 126px",
                    strokeDasharray: 470,
                    strokeDashoffset: { 470: 0 },
                    //angleZ: { 90: 0 },
                    delay: 400,
                  },
                  t
            ...
            // "vertical letter-x-last": new n.a.Html(
            //   n.a.helpers.extend(
            //     {
            //       el: ".shape-letter-x1-last",
            //       transformOrigin: "244px 126px",
      ...
      c.a.BaseView.extend({
        ...
        onEnter: function () {
          ...
          r.addEventListener("submit", function (t) {
            ...
            n.open("POST", "/mail", "async/message"),
              n.setRequestHeader(
                "Content-Type",
              ...
              n.send(JSON.stringify({"message": e.value}));
          });
        },
        onEnterCompleted: function () {
      ...
      c.a.Dispatcher.on("transitionCompleted", function (_to,_from) {
        if ((!G.preloaded))
          return (
            f.a.init({
              elemCushion: 1,
              ...
              callback: function (t, e) {
                ...
                else if ("legal-notices" === r ) i = G.arcTweenLegal;
                else {
                  if ("contact" !== r ) return;
                  i = G.arcTween;
                }
                ...
                // NOTE: Jupiter - Check hidden object and so on
                // if (e === 'visible') {
      ...
      (function () {
        ...
        class LogoBox extends mojs.CustomShape {
          getShape() {
            return document.getElementById("mysvg").innerHTML;
          }
        }
        mojs.addShape("logo", LogoBox); // passing name and Bubble class

        class LetterP extends mojs.CustomShape {
          getShape() {
            return '<path d="M 8.359 15.094 L 3 15.094 L 3 24 L 0 24 L 0 1.25 L 8.391 1.25 Q 11.347 1.25 13.29 2.445 A 6.539 6.539 0 0 1 14.242 3.156 A 6.3 6.3 0 0 1 16.33 7.484 A 8.713 8.713 0 0 1 16.359 8.203 A 8.472 8.472 0 0 1 16.115 10.3 A 5.741 5.741 0 0 1 14.289 13.305 Q 12.586 14.776 9.674 15.037 A 14.72 14.72 0 0 1 8.359 15.094 Z M 3 3.719 L 3 12.641 L 8.391 12.641 Q 10.047 12.641 11.171 12.104 A 3.9 3.9 0 0 0 12.078 11.508 A 3.655 3.655 0 0 0 13.208 9.587 Q 13.359 8.97 13.359 8.234 A 5.212 5.212 0 0 0 13.168 6.785 A 3.953 3.953 0 0 0 12.078 4.984 Q 10.836 3.803 8.698 3.723 A 8.227 8.227 0 0 0 8.562 3.719 L 3 3.719 Z" id="0" vector-effect="non-scaling-stroke"/>';
          }
        }
        mojs.addShape("P", LetterP);

        class LetterR extends mojs.CustomShape {
          getShape() {
            return '<path d="M 27.906 7 L 27.906 9.688 A 8.003 8.003 0 0 0 27.043 9.594 A 9.892 9.892 0 0 0 26.484 9.578 A 5.11 5.11 0 0 0 24.958 9.791 Q 23.403 10.277 22.682 11.869 A 5.136 5.136 0 0 0 22.625 12 L 22.625 24 L 19.734 24 L 19.734 7.094 L 22.547 7.094 L 22.594 9.047 Q 23.946 6.892 26.373 6.787 A 5.817 5.817 0 0 1 26.625 6.781 Q 27.392 6.781 27.823 6.962 A 1.367 1.367 0 0 1 27.906 7 Z" id="1" vector-effect="non-scaling-stroke"/>';
          }
        }
        mojs.addShape("R", LetterR);

        class LetterO extends mojs.CustomShape {
          getShape() {
            return '<path d="M 29.797 15.594 L 29.797 15.391 A 10.868 10.868 0 0 1 30.106 12.754 A 9.148 9.148 0 0 1 30.773 10.922 A 7.68 7.68 0 0 1 32.248 8.84 A 6.958 6.958 0 0 1 33.492 7.859 A 7.24 7.24 0 0 1 36.85 6.803 A 8.856 8.856 0 0 1 37.469 6.781 A 8.096 8.096 0 0 1 40.147 7.207 A 6.886 6.886 0 0 1 43.055 9.172 A 8.14 8.14 0 0 1 44.9 12.829 A 11.992 11.992 0 0 1 45.187 15.531 L 45.188 15.734 A 11.071 11.071 0 0 1 44.905 18.283 A 9.164 9.164 0 0 1 44.242 20.164 A 7.312 7.312 0 0 1 42.367 22.618 A 7.113 7.113 0 0 1 41.539 23.219 A 7.272 7.272 0 0 1 38.269 24.28 A 8.991 8.991 0 0 1 37.5 24.312 A 8.042 8.042 0 0 1 34.832 23.887 A 6.891 6.891 0 0 1 31.93 21.922 A 8.169 8.169 0 0 1 30.06 18.171 A 11.938 11.938 0 0 1 29.797 15.594 Z M 33.575 19.591 A 5.493 5.493 0 0 0 34.008 20.25 A 4.125 4.125 0 0 0 36.999 21.93 A 5.249 5.249 0 0 0 37.5 21.953 A 4.512 4.512 0 0 0 39.24 21.629 Q 40.265 21.204 41 20.227 A 5.859 5.859 0 0 0 41.906 18.387 Q 42.297 17.097 42.297 15.391 Q 42.297 12.609 40.977 10.883 A 4.376 4.376 0 0 0 39.501 9.619 Q 38.643 9.178 37.574 9.157 A 5.464 5.464 0 0 0 37.469 9.156 A 4.334 4.334 0 0 0 35.596 9.553 Q 34.73 9.961 34.069 10.791 A 5.389 5.389 0 0 0 34.016 10.859 A 5.65 5.65 0 0 0 33.119 12.628 Q 32.703 13.949 32.703 15.734 Q 32.703 18.033 33.575 19.591 Z" id="2" vector-effect="non-scaling-stroke"/>';
          }
        }
        mojs.addShape("O", LetterO);

        class LetterB extends mojs.CustomShape {
          getShape() {
            return '<path d="M 63.125 15.484 L 63.125 15.734 A 13.709 13.709 0 0 1 62.895 18.323 Q 62.607 19.822 61.957 21.011 A 7.613 7.613 0 0 1 61.344 21.961 Q 59.618 24.239 56.749 24.31 A 7.512 7.512 0 0 1 56.563 24.313 A 7.251 7.251 0 0 1 54.448 24.02 A 5.551 5.551 0 0 1 51.609 22.047 L 51.469 24 L 48.813 24 L 48.813 0 L 51.703 0 L 51.703 8.953 A 5.708 5.708 0 0 1 55.851 6.809 A 8.124 8.124 0 0 1 56.531 6.781 A 6.525 6.525 0 0 1 58.775 7.151 A 5.615 5.615 0 0 1 61.367 9.109 Q 63.125 11.438 63.125 15.484 Z M 51.703 11.891 L 51.703 19.203 A 5.433 5.433 0 0 0 52.72 20.646 Q 53.867 21.784 55.609 21.855 A 5.763 5.763 0 0 0 55.844 21.859 A 4.287 4.287 0 0 0 57.327 21.614 A 3.697 3.697 0 0 0 59.078 20.25 A 5.206 5.206 0 0 0 59.783 18.814 Q 60.22 17.471 60.234 15.532 A 17.825 17.825 0 0 0 60.234 15.406 A 12.333 12.333 0 0 0 60.123 13.692 Q 60 12.821 59.743 12.109 A 5.276 5.276 0 0 0 59.094 10.844 A 3.664 3.664 0 0 0 56.426 9.27 A 5.151 5.151 0 0 0 55.813 9.234 Q 52.953 9.234 51.703 11.891 Z" id="3" vector-effect="non-scaling-stroke"/>';
          }
        }
        mojs.addShape("B", LetterB);

        class LetterE extends mojs.CustomShape {
          getShape() {
            return '<path d="M 66.031 16.016 L 66.031 15.484 A 11.269 11.269 0 0 1 66.302 12.964 A 9.178 9.178 0 0 1 66.992 10.992 A 7.79 7.79 0 0 1 68.583 8.768 A 7.229 7.229 0 0 1 69.68 7.898 A 6.757 6.757 0 0 1 73.422 6.781 A 8.015 8.015 0 0 1 75.602 7.062 A 5.829 5.829 0 0 1 78.547 8.953 A 7.093 7.093 0 0 1 79.859 11.401 Q 80.375 13.022 80.375 15.172 L 80.375 16.375 L 68.922 16.375 A 7.507 7.507 0 0 0 69.175 18.181 A 5.39 5.39 0 0 0 70.383 20.414 A 4.558 4.558 0 0 0 73.704 21.949 A 5.873 5.873 0 0 0 73.938 21.953 Q 75.408 21.953 76.447 21.376 A 3.932 3.932 0 0 0 76.531 21.328 A 6.496 6.496 0 0 0 78.341 19.736 A 7.367 7.367 0 0 0 78.391 19.672 L 80.156 21.047 A 6.849 6.849 0 0 1 75.179 24.216 A 9.775 9.775 0 0 1 73.781 24.312 A 8.513 8.513 0 0 1 71.11 23.911 A 7.02 7.02 0 0 1 68.188 22.055 A 7.593 7.593 0 0 1 66.252 18.282 A 11.032 11.032 0 0 1 66.031 16.016 Z M 69.016 14 L 77.484 14 L 77.484 13.781 Q 77.392 12.15 76.785 11.062 A 4.018 4.018 0 0 0 76.297 10.367 A 3.495 3.495 0 0 0 73.97 9.186 A 4.941 4.941 0 0 0 73.422 9.156 A 3.933 3.933 0 0 0 71.564 9.593 A 4.053 4.053 0 0 0 70.484 10.43 A 5.038 5.038 0 0 0 69.501 12.015 Q 69.152 12.887 69.016 14 Z" id="4" vector-effect="non-scaling-stroke"/>';
          }
        }
        mojs.addShape("E", LetterE);

        class LetterX extends mojs.CustomShape {
          getShape() {
            return '<path d="M 86.109 1.25 L 91.594 9.969 L 97.047 1.25 L 100.578 1.25 L 93.391 12.531 L 100.75 24 L 97.188 24 L 91.594 15.125 L 85.969 24 L 82.422 24 L 89.797 12.531 L 82.594 1.25 L 86.109 1.25 Z" id="5" vector-effect="non-scaling-stroke"/>  ';
          }
        }
        mojs.addShape("X", LetterX);

        //#################################
        // Animation
        const parent = document.querySelector(".preload");
        const animation_symbol_conf = {
          base: "#5f5f5f",
          vibrant: "#f98c88",
          contrast: "#fff",
        ...
        var S = new mojs.Timeline({ delay: 100});

        var timeline_Box = new mojs.Timeline({ delay: 100 });

        const rectLogo = new mojs.Shape({
          parent: parent,
          shape: "logo",
          rx: 3,
          fill: "#29363B",
        ...
        var TAG_LINES = new (mojs.stagger(mojs.Shape))({
          parent: parent,
          quantifier: 16,
          shape: "line",
          stroke: [animation_symbol_conf.bright, animation_symbol_conf.vibrant],
          strokeDasharray: "100%",
          strokeDashoffset: { "100%": "300%" },
          radius: "rand(25, 35)",
          angle: "-45",
          duration: "rand(250, 700)",
          delay: "stagger(600, rand(50, 100))",
          opacity: "rand(0.5, 1)", //{ 1: 0, curve: 'linear' },
          strokeWidth: { "rand(1, 4)": 0 },
          x: "rand(40, 100)",
          y: "rand(-90, -50)",
        });

        timeline_Box.add(rectLogo);

        var P = new mojs.Shape(
          mojs.helpers.extend(
            {
              shape: "P",
          ...
          mojs.helpers.extend(
            {
              ...
              scaleX: { 2: 2 },
              scaleY: { 2: 2 },
              delay: effect_stroke.interval,
            },
            effect_stroke
          )
        ).then(effect_out);

        var O = new mojs.Shape(
          mojs.helpers.extend(
            {
              shape: "O",
              scaleX: { 2: 2 },
              scaleY: { 2: 2 },
              fill: { transparent: animation_symbol_conf.base },
              delay: 2 * effect_stroke.interval,
            },
            effect_stroke
          )
        ).then(effect_out);

        var B = new mojs.Shape(
          mojs.helpers.extend(
            {
              shape: "B",
              fill: { transparent: animation_symbol_conf.base },
              scaleX: { 2: 2 },
              scaleY: { 2: 2 },
              delay: 3 * effect_stroke.interval,
            },
            effect_stroke
          )
        ).then(effect_out);

        var E = new mojs.Shape(
          mojs.helpers.extend(
            {
              shape: "E",
              scaleX: { 2: 2 },
              scaleY: { 2: 2 },
              fill: { transparent: animation_symbol_conf.base },
              delay: 4 * effect_stroke.interval,
            },
            effect_stroke
          )
        ).then(effect_out);

        var X = new mojs.Shape(
          mojs.helpers.extend(
            {
              shape: "X",
              fill: { transparent: animation_symbol_conf.base },
              ...
              scaleY: { 2: 2 },
              strokeDashoffset: { "100%": 0 },
              delay: 5 * effect_stroke.interval,
            },
            effect_stroke
          )
        ).then(effect_out);

        S.add(P, R, O, B, E, X, TAG_LINES);
            ...
            "base" === a.getAttribute("data-color")
              ? ($.tune(),
                new n.a.Shape({
                  ...
                  y: G.dotEventY,
                  radius: { 0: G.dotRadius },
                  fill: '#F2F2F2',//animation_symbol_conf[G.dotColor],
                  duration: 1400,
                  easing: n.a.easing.quint.inout,
                  onStart: function () {
                    this.el.style.position = "fixed";
